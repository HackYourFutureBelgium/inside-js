...
const i = 1 || (0 && 0) || 2;
console.assert(i === 1, 'i');      // || always start from left if it is true !== to the right

const j = (1 || 0) && (0 || 2);
console.assert(j === 2, 'j');      // && always start from right if it is true !== 0 
